...
class CreateCostReportRealtimeTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cost_report_realtime', function (Blueprint $table) {
            $table->bigIncrements('cost_report_realtime_id');
            $table->unsignedBigInteger('project_id');
            $table->double('cost_expense');
            $table->double('balance');
            $table->boolean('cost_report_cashflow');
            $table->text('cost_report_realtime_desc');
    ...
    {
        Schema::dropIfExists('cost_report_realtime');
    }
}
