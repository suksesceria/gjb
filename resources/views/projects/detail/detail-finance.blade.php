            ...
            <form action="">
                ...
                ?>
                    <div class="form-group">
                        <label>Tanggal</label>
                        <input class="form-control date"  readonly type="date" id="modal-detail-keuangan-lapangan-date" value="{{ date_format($data->cost_report_office_date,'Y-m-d') }}"  disbaled>
                    </div>
                    <div class="form-group">
                        <label>Keterangan</label>
                        <input class="form-control description" readonly type="text" id="modal-detail-keuangan-lapangan-description" value="{{$data->cost_report_office_desc}}" disbaled>
                    </div>
                    <div class="form-group">
                        <label>Debit</label>
                    ...
                    <div class="text-right">
                        ...
                        if(Auth::user()->role_id == 1  && $data->status == 0){
                            ...
                            $tolak = 2;
                        @endphp
                        <a href="{{ url('/projects/'.$data->cost_report_office_id.'/'.$tolak.'/'.$data->project_id.'/verify') }}">
                            <button type="button" class="btn btn-danger">Tolak</button>
                        </a>
                        <a href="{{ url('/projects/'.$data->cost_report_office_id.'/'.$verif.'/'.$data->project_id.'/verify') }}">
